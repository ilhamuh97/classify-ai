...
export const createClassContext: HeaderContext = {
...
export const setupParametersContext: HeaderContext = {
...
export const trainContext: HeaderContext = {
...
export const predictContext: HeaderContext = {
