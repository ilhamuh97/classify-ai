...
export const classConfigValue: ClassConfigItem[] = [
    {
        key: 0,
        label: 'Class 1',
        cameraState: false
...
export const paramConfigValue: ParamConfig = {
...
export const graphModelOptions: SelectOption<string>[] = [
    {
...
export const optimizerOptions: SelectOption<string>[] = [
    {
        value: 'adam',
        label: 'Adam'
    },
