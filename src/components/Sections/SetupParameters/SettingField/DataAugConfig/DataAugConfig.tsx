...
import { DataAugmentationConfig, DatasetItem } from '../../../../../types';
...
const DataAugConfig = ({
    ...
    const draw = (p5: P5) => {
        ...
        randomImgIndex = parseInt(String(p5.random(0, dataset.length - 1)));
        // load image
        ...
        <Space direction="vertical" className={styles.dataAugConfig}>
            ...
            {dataAugmentationConfig.isActive ? (
                <Space align="center" direction="vertical" className={styles.displaySection}>
                    ...
                    <Button
                        onClick={() => setClickedSeed(parseInt(String(Math.random() * 100000)))}
                        icon={<ReloadOutlined />}>
                        Generate Image
                    </Button>
                </Space>
